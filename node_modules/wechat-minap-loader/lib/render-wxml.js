...
module.exports = async function (template) {
  ...
  // const isComponent = fullPath.indexOf('components') > -1;
  const folder = dirname.slice(process.cwd().length);

  // console.log(dirname, folder, filename, fullPath, process.cwd());

  fs.outputFileSync(resolve(process.cwd(), `${dist}/${folder}/${filename}`), html, 'utf8')
